...
function RegisterFarmer() {
  ...
  const { farmerId, farmerName, email, phoneNo, password } = Record;
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    try {
      await Service.Registerfarmer(Record);
      // alert("Registraction Successfully Completed " + Record.farmerName);
          ...
          <form id="forms" action="#" onSubmit={(e) => onSubmit(e)}>
            ...
            <div className="input-group mb-3">
              ...
              <TextField
                ...
                inputProps={{
                  pattern: "[0-9]{10}",
                  title: "Please enter 10 digits only",
                }}
              />
            </div>
            <div className="input-group mb-3">
