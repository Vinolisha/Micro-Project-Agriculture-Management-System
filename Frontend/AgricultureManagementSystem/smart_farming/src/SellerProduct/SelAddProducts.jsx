  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8090/SellerProduct/insertSellerProduct",
        formData,
        {
          headers: {
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-5 offset-md-3 border rounded p-3 mt-6 shadow ">
          <h4 className="text-center m-2">ADD SEEDS DETAILS</h4>
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              />
                ...
                <Link className="btn btn-dark mx-2" to="/homePage">
